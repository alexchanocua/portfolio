...
const project = {
    ...
    stack: ['Javascript', 'React', 'Node.js', 'Express JS', 'PostgreSQL', 'Material UI',],
    type: 'Social',
    site: 'https://alexchanocua.github.io/ultraV2/',
    goal: 'Create a website where users can sign in and upload their art/photography into their own profile.',
    stackExp: 'I designed and architected Ultra, then integrated my custom API to allow users to share their' +
    ' art/photography.' + ' I built the project using React JS because of its performative, structured, and productive library and leveraged Material UI responsive framework. The front end was deployed on GitHub Pages. ' +
